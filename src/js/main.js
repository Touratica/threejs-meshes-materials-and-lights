...
function __init__() {
	...
	createScene();
	//PerspectiveCamera = createPerspectiveCamera(100,0, 20); //Lateral
	//PerspectiveCamera = createPerspectiveCamera(-100,50, 20); // Lateral
	//PerspectiveCamera = createPerspectiveCamera(-20,-45, 80); //Frontal
	PerspectiveCamera = createPerspectiveCamera(0,100, 40); //Back
